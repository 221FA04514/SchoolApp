...
INSERT INTO `announcements` VALUES (1,'Circular for Holiday','Tomorrow is declared a holiday due to second Saturday.',3,'teacher','2025-12-30 07:45:29'),(2,'Homework','Complete math activity book pages 30 and 31.',3,'teacher','2025-12-30 07:45:35'),(3,'Exam Notice','Unit test will be conducted on Friday.',6,'teacher','2025-12-30 08:21:33'),(4,'Exam Notice','Unit test will be conducted on Friday.',6,'teacher','2025-12-30 08:28:11'),(5,'Unit Test Reminder','Unit test starts from Monday. Be prepared.',6,'teacher','2026-01-06 05:00:33');
...
INSERT INTO `homework` VALUES (1,'Math Practice','Solve problems 1 to 10 from exercise 5','Mathematics',1,'2026-01-10',3,'2026-01-06 08:48:03'),(2,'Science Worksheet','Complete chapter 3 questions','Science',1,'2026-01-12',6,'2026-01-06 08:55:24');
...
INSERT INTO `messages` VALUES (1,3,6,'student','Sir, can you explain quadratic equations?','2025-12-31 04:27:14'),(2,3,6,'teacher','Sure, I will explain it in tomorrow\'s class.','2025-12-31 04:30:07'),(3,7,6,'student','Sir, can you explain quadratic equations?','2025-12-31 10:27:47'),(4,7,6,'student','hello sir','2026-01-02 07:12:22'),(5,7,6,'teacher','sure i will explain ','2026-01-02 13:51:02'),(6,3,6,'teacher','hello','2026-01-07 10:07:56'),(7,7,6,'teacher','hey hi','2026-01-07 10:08:06'),(8,7,6,'teacher','mam','2026-01-07 10:08:08'),(9,7,6,'teacher','sir','2026-01-07 10:08:11'),(10,7,6,'student','<','2026-01-10 05:12:50'),(11,7,6,'teacher','good mng','2026-01-11 03:57:26');
...
INSERT INTO `sections` VALUES (1,'10','A','10-A');
...
CREATE TABLE `student_homework_status` (
  ...
  CONSTRAINT `student_homework_status_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE,
...
INSERT INTO `student_homework_status` VALUES (1,5,1,0,'2026-01-11 03:53:56'),(2,5,2,1,'2026-01-11 03:54:00');
...
INSERT INTO `students` VALUES (4,3,'Rahul Kumar','10','A','23',NULL,NULL,NULL,'2025-12-30 05:56:19',1),(5,7,'Test Student','10','A','01',NULL,NULL,NULL,'2025-12-31 06:14:32',1);
...
INSERT INTO `timetable` VALUES (1,1,'Monday',1,'Maths','Mr. Rao','09:00:00','09:45:00','2026-01-07 05:52:44'),(2,1,'Monday',2,'Science','Ms. Anita','09:45:00','10:30:00','2026-01-07 05:52:44'),(4,1,'Wednesday',1,'c program','sathvi','09:15:00','10:25:00','2026-01-07 06:48:02');
...
-- Dump completed on 2026-01-11  9:51:46
